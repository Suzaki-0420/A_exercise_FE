...
export class UpdateOrderStatusService implements IUpdateOrderStatusService {
  ...
  public async findById(
    ...
    return await this.ordersRepository.findById(orderUuid);
  }
  ...
  public async confirmStatusUpdate(
    ...
    return await this.ordersRepository.confirmStatusUpdate(
      orderId,
      newStatusId,
    );
  }
  ...
  public async updateStatus(
    ...
    return await this.ordersRepository.updateStatus(orderId, newStatusId);
  }
}
