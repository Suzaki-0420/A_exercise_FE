...
export class OrdersRepository implements IOrdersRepository {
  ...
  public async findAll(): Promise<OrderSearchItem[]> {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        `購入履歴一覧の取得に失敗しました ` + `(Status: ${response.status})`,
      );
    }
  ...
  public async search(
    ...
    // TODO: 実際のControllerのURLに合わせて修正する
    const url = `/proxy-api/order/search/result?${params.toString()}`;
  ...
  public async findById(
    ...
    // TODO: 実際のControllerのURLに合わせて修正する
    const url = `/proxy-api/order/status/update/${encodeURIComponent(orderUuid)}`;
    ...
    if (!response.ok) {
      ...
      throw new Error(
        `注文情報の取得に失敗しました ` + `(Status: ${response.status})`,
      );
    }
  ...
  public async confirmStatusUpdate(
    ...
    // TODO: 実際のControllerのURLに合わせて修正する
    const url = "/proxy-api/order/status/update/confirm";
  ...
  public async updateStatus(
    ...
    // TODO: 実際のControllerのURLに合わせて修正する
    const url = "/proxy-api/order/status/update/complete";
    ...
    if (!response.ok) {
      ...
      console.log("update error body:", errorData);
      console.log("=========================================");
  ...
  private throwApiError(
    ...
    throw new Error(`${defaultMessage} ` + `(Status: ${status})`);
  }
}
