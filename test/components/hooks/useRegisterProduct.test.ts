...
import {
    useRegisterProduct,
} from "@/components/hooks/useRegisterProduct";
    ...
    () => {
        ...
        describe(
            ...
            () => {
                ...
                it(
                    "重複確認でErrorが投げられた場合messageを表示する",
                    async () => {
                        mockValidateProductName
                ...
                it(
                    "重複確認でError以外が投げられた場合既定メッセージを表示する",
                    async () => {
                        mockValidateProductName
                            .mockRejectedValueOnce(
                                "unexpected"
        ...
        describe(
            ...
            () => {
                ...
                it(
                    "登録成功時にServiceを正しい引数で呼び状態を初期化する",
                    async () => {
                        mockRegisterProduct
                ...
                it(
                    "Serviceがnullを返した場合モーダルを閉じずトーストを表示しない",
                    async () => {
                        mockRegisterProduct
                            .mockResolvedValueOnce(
                                null
                ...
                it(
                    "validation以外のJSONはsubmitエラーになる",
                    async () => {
                        const message =
                            JSON.stringify({
                                type:
        ...
        it(
            "カテゴリ取得エラーが解消した場合systemエラーだけを削除する",
            () => {
                mockUseProductCategories
                    .mockReturnValue({
                        categories: [],
        ...
        it(
            "カテゴリ取得成功時にsystemエラーが存在しなければerrorsを変更しない",
            () => {
                mockUseProductCategories
                    .mockReturnValue({
                        categories: [
        ...
        it(
            "同じカテゴリ取得エラーで再レンダーした場合systemエラーを変更しない",
            () => {
                mockUseProductCategories
                    .mockReturnValue({
                        categories: [],
