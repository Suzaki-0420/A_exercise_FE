...
export const TYPES = {
  ...
  ISearchProductByCategoryService: Symbol.for(
    "ISearchProductByCategoryService",
  ),
  ISearchOrdersService: Symbol.for("ISearchOrdersService"),
  IRegisterEmployeeAccountService: Symbol.for(
  ...
  IUpdateOrderStatusService: Symbol.for("IUpdateOrderStatusService"),
};
