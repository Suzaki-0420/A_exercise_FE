    ...
    <>
          ...
          {isInitialLoading ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div className="grid grid-cols-[160px_1fr] items-start gap-4">
                <label htmlFor="employeeUuid" className="pt-2 text-right">
                  社員名
                </label>
                ...
                <div>
                  <select
                    ...
                    disabled={isLoading || employeeAccounts.length === 0}
                    aria-invalid={Boolean(errors.employeeUuid)}
                    className={`w-full rounded border px-3 py-2 ${
                      errors.employeeUuid ? "border-red-500" : "border-gray-300"
                    }`}
                  >
                    ...
                    {employeeAccounts.map((account) => (
                      <option
                        key={account.employee?.employeeUuid}
                        value={account.employee?.employeeUuid ?? ""}
                      >
                  ...
                  {employeeAccounts.length === 0 && !errors.system && (
          ...
          >
            ...
            <dl className="space-y-4">
              <div className="grid grid-cols-[140px_1fr] gap-4 border-b pb-3">
                <dt className="font-semibold">社員名</dt>

                <dd>{selectedEmployeeName}</dd>
              </div>

              <div className="grid grid-cols-[140px_1fr] gap-4 border-b pb-3">
                <dt className="font-semibold">アカウント名</dt>

                <dd>{formData.name}</dd>
              </div>

              <div className="grid grid-cols-[140px_1fr] gap-4 border-b pb-3">
                <dt className="font-semibold">パスワード</dt>
            ...
            <div className="mt-8 flex justify-center gap-4">
              ...
              <button
                type="button"
                onClick={confirmRegisterEmployeeAccount}
                disabled={isLoading}
      ...
      {isToastVisible && (
        ...
        >
          ...
          <p className="font-semibold">担当者アカウントを登録しました。</p>
