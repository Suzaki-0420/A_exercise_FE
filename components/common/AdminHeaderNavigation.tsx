...
export const AdminHeaderNavigation = () => {
  ...
  if (pathname === "/admin/login") {
    return <div aria-hidden="true" className="mt-3 h-9" />;
  }
  ...
  return (
    ...
    >
      ...
      <Link href="/admin/category/register" className="hover:underline">
        商品カテゴリ登録
      </Link>

      <Link href="/admin/order/search" className="hover:underline">
        購入履歴
      </Link>

      <Link href="/admin/account/register" className="hover:underline">
        アカウント登録
      </Link>
