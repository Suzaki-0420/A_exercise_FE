    ...
    <>
      <main className="flex min-h-screen justify-center bg-white px-6 py-12">
        <section className="w-full max-w-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            {/* 単価 */}
            <div className="grid grid-cols-[140px_1fr] items-start gap-4">
              <label htmlFor="price" className="pt-2 text-right">
                単価
              </label>
            ...
            {/* 在庫数 */}
            <div className="grid grid-cols-[140px_1fr] items-start gap-4">
              <label htmlFor="stock" className="pt-2 text-right">
                在庫数
              </label>
              ...
              <div>
                <input
                  ...
                  type="number"
                  value={
                    Number.isNaN(formData.productStock?.quantity)
                      ? ""
            ...
            {/* 商品カテゴリ */}
            <div className="grid grid-cols-[140px_1fr] items-start gap-4">
              <label htmlFor="categoryUuid" className="pt-2 text-right">
                商品カテゴリ
              </label>
          ...
          >
            ...
            <dl className="space-y-4">
              <div className="grid grid-cols-[120px_1fr] gap-4 border-b border-gray-200 pb-3">
                <dt className="font-semibold">商品名</dt>

                <dd className="break-words">{formData.name}</dd>
              </div>

              <div className="grid grid-cols-[120px_1fr] gap-4 border-b border-gray-200 pb-3">
                <dt className="font-semibold">単価</dt>

                <dd>{formData.price.toLocaleString()}円</dd>
              </div>

              <div className="grid grid-cols-[120px_1fr] gap-4 border-b border-gray-200 pb-3">
                <dt className="font-semibold">在庫数</dt>

                <dd>{formData.productStock?.quantity ?? 0}個</dd>
              </div>

              <div className="grid grid-cols-[120px_1fr] gap-4 border-b border-gray-200 pb-3">
                <dt className="font-semibold">商品カテゴリ</dt>

                <dd>{formData.productCategory?.name ?? "未選択"}</dd>
              </div>

              <div className="grid grid-cols-[120px_1fr] gap-4 border-b border-gray-200 pb-3">
                <dt className="font-semibold">商品画像</dt>
      ...
      {isToastVisible && (
        ...
        >
          ...
          <p className="font-semibold">商品を登録しました。</p>
