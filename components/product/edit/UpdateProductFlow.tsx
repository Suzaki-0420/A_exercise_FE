 ...
 */
export const UpdateProductFlow = ({ productUuid }: { productUuid: string }) => {
  const [modalStep, setModalStep] = useState<UpdateModalStep>("closed");
  ...
  return (
    <>
      <UpdateProduct
        ...
        options={{
          onProceedToConfirm: openConfirmModal,
        }}
      />
