...
import { CheckCircle2Icon, HouseIcon, SearchIcon } from "lucide-react";
...
export const UpdateProductComplete = ({
  ...
  const { completedResult, handleInvalidFlow, handleLeaveComplete } =
    useUpdateProduct();
  ...
  const content = (
    ...
    >
      ...
      <p className="mt-3 text-gray-700">商品情報の修正が完了しました。</p>
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2">
        <Button
          type="button"
          variant="outline"
          onClick={() => handleLeaveComplete("/admin")}
        >
        ...
        <Button
          type="button"
          onClick={() => handleLeaveComplete("/admin/product")}
