...
type UpdateProductContextValue = {
  ...
  saveDraft: (product: Product, imageFile: File | null) => void;
  setCompletedResult: (result: ProductUpdateResult) => void;
  clearFlow: () => void;
};

const UpdateProductContext = createContext<UpdateProductContextValue | null>(
  null,
);
...
export const UpdateProductProvider = ({
  ...
  const setCompletedResult = useCallback((result: ProductUpdateResult) => {
