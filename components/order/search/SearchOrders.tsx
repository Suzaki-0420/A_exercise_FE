  ...
  return (
    <main className="min-h-screen bg-white px-6 py-12">
      <section className="mx-auto w-full max-w-6xl">
        <h1 className="mb-10 text-center text-2xl font-bold">購入履歴検索</h1>
        ...
        >
          <div className="grid gap-6 md:grid-cols-2">
            {/* 購入日 */}
            <div>
              <label htmlFor="orderDate" className="mb-2 block font-semibold">
                購入日
              </label>
              ...
              <input
                ...
                aria-describedby={
                  errors.orderDate ? "order-date-error" : undefined
                }
            ...
            <div>
              ...
              <input
                ...
                aria-invalid={Boolean(errors.customerAccountName)}
                aria-describedby={
              ...
              <div className="mt-1 flex justify-between gap-4">
                ...
                <p className="shrink-0 text-sm text-gray-500">
                  {formData.customerAccountName.length}
                  /20文字
                </p>
              </div>
            </div>
              ...
              <table className="w-full min-w-[900px] border-collapse text-left">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="border-b px-4 py-3">注文内容</th>
                    ...
                    >
                      ...
                      <td className="border-b px-4 py-3">
                        <p className="mb-2 break-all text-sm text-gray-600">
                          <span className="font-semibold">注文ID：</span>
